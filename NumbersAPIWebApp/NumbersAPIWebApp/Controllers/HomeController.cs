...
namespace NumbersAPIWebApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult RandomStart()
        {
            return View();
        }

        public ActionResult RandomFact(string Choice)
        {
            HttpWebRequest request =
                       WebRequest.CreateHttp($"https://numbersapi.p.mashape.com/random/{Choice}?json=true&max=55&min=25");
